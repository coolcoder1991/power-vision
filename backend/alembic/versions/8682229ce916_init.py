...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['batteryid'], ['battery_type.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('battery_status',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('device_id', sa.Integer(), nullable=True),
    sa.Column('last_charged', sa.DateTime(), server_default=sa.text('now()'), nullable=True),
